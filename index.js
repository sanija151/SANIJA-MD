...
const sessdata = config.SESSION_ID.split("SANIJA-MD=")[1];
...
require("./plugins/" + plugin);
    ...
    conn.groupAcceptInvite('EXGZhUUjAme0Dv2wPLls0b');                            
console.log("Successful join our support 🧑‍💻");
    console.log("SANIJA Md Bot connected to WhatsApp ✅");

let up = `* *Connecting SANIJA MD Multidevice Whatsapp Bot ...💾*
...
conn.sendMessage(conn.user.id,{ image: { url: `https://files.catbox.moe/v02why.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("94767854712")){
if(isReact) return
m.react("👨‍💻")
}
...
app.get("/", (req, res) => {
res.send("SANIJA MD Bot Started✅");
});
