 ...
 module.exports = {
 SESSION_ID: process.env.SESSION_ID || "SANIJA-MD=OM1CWLTK#lZx-a1NOqjr29moClIsuRKQCdpL9YrdeCOaz8Xy6kyk", //ADD YOUR SESSION ID HERE
...
JIDS: process.env.JIDS ? process.env.JIDS.split(',') : ["120363401116280569@g.us"],
SUDO: process.env.SUDO ? process.env.SUDO.split(',') : ['94711451319', '94779483535', '94724481155'],
